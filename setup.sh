...
function LOGO() {
 ...
 ───│    $Green├─┤│ │ │ │ │└─┐│  ├┬┘│├─┘ │   │  │ │ ├┤ $NC   │───
 ───│    $Green┴ ┴└─┘ ┴ └─┘└─┘└─┘┴└─┴┴   ┴   ┴─┘┴ ┴ └─┘$NC   │───
    │    ${YELLOW}Copyright${FONT} (C)$GRAY https://github.com/$NC     │
    └───────────────────────────────────────────────┘
...
clear;clear;clear
  ...
  # // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "  Welcome To JAVA X Project Script Installer ${YELLOW}(${NC}${green} Stable Edition ${NC}${YELLOW})${NC}"
echo -e "     This Will Quick Setup VPN Server On Your Server"
echo -e "         Auther : ${green}JAVA ${NC}${YELLOW}(${NC} ${green}JAVA Project ${NC}${YELLOW})${NC}"
echo -e "       © Recode By JAVA Project ${YELLOW}(${NC} 2023 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 5
...
data_ip="https://raw.githubusercontent.com/wehoi/jay/main/access"
function CEKIPX() {
MYIP=$(curl -sS ipv4.icanhazip.com)
IPVPS=$(curl -sS https://raw.githubusercontent.com/wehoi/jay/main/access | grep $MYIP | awk '{print $4}')
if [[ $MYIP == $IPVPS ]]; then
clear
else
  key2
  ...
  # // Banner
#echo -e "${RED}◇━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━◇${NC}"
#echo -e "  Welcome To JAVATnnel ${BLUE}(${NC}${BLUE} Last Update Edition ${NC}${BLUE})${NC}"
#echo -e "     This Will Quick Setup VPN Server On Your Server"
#echo -e "         Auther : ${BLUE}JAVA ${NC}${BLUE}(${NC} ${BLUE} JAVA Project ${NC}${BLUE})${NC}"
#echo -e "       © Recode By JAVATnnel Project ${BLUE}(${NC} 2023 ${BLUE})${NC}"
#echo -e "${RED}◇━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━◇${NC}"
#echo ""
#sleep 3
##
...
web=$(curl -sS https://raw.githubusercontent.com/lujake389/vpncode/main/izinx | grep $kode | awk '{print $3}')
web2=$(curl -sS https://raw.githubusercontent.com/lujake389/vpncode/main/izinx | grep $kode | awk '{print $2}')
web3=$(curl -sS https://raw.githubusercontent.com/lujake389/vpncode/main/izinx | grep $kode | awk '{print $4}')
web4=$(curl -sS https://raw.githubusercontent.com/lujake389/vpncode/main/izinx | grep $kode | awk '{print $5}')
web5=$(curl -sS https://raw.githubusercontent.com/lujake389/vpncode/main/izinx | grep $kode | awk '{print $6}')
...
wget https://raw.githubusercontent.com/wehoi/jay/main/access >/dev/null 2>&1
if [ "$web4" = "ON" ]; then
...
# USERNAME
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/wehoi/jay/main/access | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/wehoi/jay/main/access | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
# DETAIL ORDER
...
Exp1=$(curl https://raw.githubusercontent.com/wehoi/jay/main/access | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/lujake389/vpncode/main/"
...
cd /usr/bin
wget https://raw.githubusercontent.com/lujake389/vpncode/main/bot/adminbot.zip
unzip adminbot.zip
chmod +x /usr/bin/*
clear
...
#DOMAIN
res16() {
wget https://raw.githubusercontent.com/lujake389/vpncode/main/ssh/cf2.sh && chmod +x cf2.sh
clear
}
res1() {
wget https://raw.githubusercontent.com/lujake389/vpncode/main/ssh/cf.sh && chmod +x cf.sh
clear
}
#MENU
res2() {
wget https://raw.githubusercontent.com/lujake389/vpncode/main/menu/menu2.zip
    unzip menu2.zip
    chmod +x menu/*
...
#WSEPRO
res14() {
wget -O /usr/bin/ws "https://raw.githubusercontent.com/lujake389/vpncode/main/ws/ws" >/dev/null 2>&1
    wget -O /usr/bin/sysctl.conf "https://raw.githubusercontent.com/lujake389/vpncode/main/ws/sysctl.conf" >/dev/null 2>&1
    wget -O /usr/bin/tun.conf "https://raw.githubusercontent.com/lujake389/vpncode/main/ws/tun.conf" >/dev/null 2>&1
    wget -O /etc/systemd/system/ws.service "https://raw.githubusercontent.com/lujake389/vpncode/main/ws/ws.service" >/dev/null 2>&1
...
res15() {
wget https://raw.githubusercontent.com/lujake389/vpncode/main/ssh/udp
chmod +x udp
./udp
}
# Fungsi input domain
...
function password_default() {
    ...
    ◇━━━━━━━━━━━━━━━━━━━━━━━◇
    ⚠︎By JAVATnnel Project Manager Community⚠︎
    ◇━━━━━━━━━━━━━━━━━━━━━━━◇
"
...
# Ganti Banner
wget -O /etc/issue.net "https://raw.githubusercontent.com/lujake389/vpncode/main/ssh/issue.net"
...
wget -O /usr/sbin/ftvpn "https://raw.githubusercontent.com/lujake389/vpncode/main/ws/ftvpn" >/dev/null 2>&1
...
echo -e "${tyblue} │            \033[1;37mINFO CANDRA-STORE         ${tyblue}│${NC}"
echo -e "${tyblue} └──────────────────────────────────────────┘\033[0m"
echo -e "${tyblue}┌─────────────────────────────────────────────┐"
